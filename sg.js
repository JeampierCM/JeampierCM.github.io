...
// ***************************************************************
const SPREADSHEET_ID = "1UaA1J3FXLgt8EmbDbdK0C-Gdbuft4cYqSmKjZk0zR_Q"; 
//https://docs.google.com/spreadsheets/d/1UaA1J3FXLgt8EmbDbdK0C-Gdbuft4cYqSmKjZk0zR_Q/edit?usp=sharing
//https://docs.google.com/spreadsheets/d/1UaA1J3FXLgt8EmbDbdK0C-Gdbuft4cYqSmKjZk0zR_Q/edit?usp=sharing
...
function iniciarBaseDeDatos() {
    ...
    //abrir la hoja de calculo en una nueva pestaña al iniciar la base de datos
    return { status: "success", 
        message: `Base de datos iniciada correctamente: ${msg.join(" ")}`,
...
function resetearBaseDeDatos() {
    ...
    return { status: "success", message: `Base de datos reseteadaaa completamente: ${msg.join(" ")}` };
}